...
<html lang="en">
<head>
<title> <?php echo $city; ?> |  <?php echo $title; ?> </title>
...
<?php include 'filter.php';?>
      ...
      <div class="col-md-9 col-sm-8 jobs-list-all">
		...
		<?php
			...
			$user_resume = mysqli_query($con, "SELECT * FROM job_listing WHERE job_location = '$city' and status = '1' and fea_job = '1' ORDER BY rand() LIMIT 2");
	...
	?>
      ...
      <?php 
			...
			$user_resume = mysqli_query($con, "SELECT * FROM job_listing WHERE job_location = '$city' and status = '1' and fea_job = '0' ORDER BY id DESC");
