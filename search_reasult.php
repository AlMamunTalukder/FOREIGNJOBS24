...
<html lang="en">
<head>
<title> <?php echo $what; ?> <?php echo $location; ?> |  <?php echo $title; ?> </title>
...
<div class="inner-heading">
  <div class="container">
    <h3>Search Kewyord : <?php echo $what; ?> <?php echo $location; ?> </h3>
  </div>
</div>
...
<?php include 'filter.php';?>
      ...
      <div class="col-md-9 col-sm-8 jobs-list-all">
		...
		<?php
			...
			$user_resume = mysqli_query($con, "SELECT * FROM job_listing WHERE job_title LIKE '%" . $what . "%' or job_location LIKE '%" . $location . "%' and status = '1' and fea_job = '0' ORDER BY id DESC");
