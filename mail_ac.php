<?php
	...
	$email_rec = $_REQUEST["email"];
	$subject = $_REQUEST["subject"];
	$message = $_REQUEST["message"];
	
	
	//Receiver Info
		$email = "info@foreignjobs24.com";
		$name = $firstname.$lastname;
		
		//Sender Info
		$sender_name = "Foregin Jobs 24";
		$sender_email = "noreplay@foreignjobs24.com";
		$sender_password = "759153@#Fj";
		
		$mail_subject = "Contact | Foregin Jobs 24";
		$message = '
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<tbody>
											...
											<td width="94%" style="font-family:Helvetica,arial,sans-serif;font-size:16px;line-height:22px;color:#333333;text-align:left">
												...
												<strong>Email: </strong>'.$email_rec.' <br/>
												<strong>Subject: </strong>'.$subject.'  <br/>
												<strong>Message: </strong>'.$message.'  <br/>
												
												This email sent form Foreignjobs24.com Contact page .
