...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    ...
                    <section class="section">
						<a href="add_package.php" class="btn btn-success btn-block btn-lg"> 
						...
						<div class="table-responsive">
						    <table class="table table-striped">
						        ...
						        <tbody>
						             <?php 
									 $i = 1;
									 $user_role_db = mysqli_query($con,"SELECT * FROM package ORDER BY ID ASC LIMIT $current, $limit");
						           ...
						           ?>
						            <tr>
										 <td><?php echo $i++; ?> </td>
										 <td><?php echo $admin_role_name = $user_rol_row['package_name']; ?> </td>
						                <td><?php 
						                	echo $admin_role = $user_rol_row['package_limit']; 
						                ?></td>
						                <td><?php echo $admin_role_name = $user_rol_row['package_fee']; ?></td>
