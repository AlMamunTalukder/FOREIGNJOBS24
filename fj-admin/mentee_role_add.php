...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        <h1 class="title">  Mentee Role Add   </h1>
                        <p class="title-description"> New Mentee Role </p>
                    </div>
                        ...
                        <div class="row sameheight-container">
                            <div class="col-md-6">
                                <div class="card card-block sameheight-item">
                                    ...
                                    <form name="submit" id="submit" method="post" action="mentee_role_add_ac.php" enctype="multipart/form-data">
									
                                        <div class="form-group"> 
											<label class="control-label">Role Name</label> 
											<input type="text" class="form-control boxed" name="roles" placeholder="Enter Role Name" required>  
										</div>
