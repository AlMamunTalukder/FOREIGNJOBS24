...
//show records
$query =  mysqli_query($con,"SELECT * FROM mentor_pre_info WHERE status = '0' ORDER BY ID DESC");
...
<div class="card-block">
	...
	<div class="table-responsive">
		<table class="table table-striped">
			...
			<tbody>
				 <?php 
				 $page_run = mysqli_query($con,"SELECT * FROM mentor_pre_info WHERE status = '0' ORDER BY ID DESC LIMIT $current, $limit");
