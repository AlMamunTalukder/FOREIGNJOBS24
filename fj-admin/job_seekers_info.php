...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM job_seeker_info ORDER BY ID ASC ");
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
			 ...
			 $page_run = mysqli_query($con,"SELECT * FROM job_seeker_info ORDER BY ID DESC LIMIT $current, $limit");
...
<?php } else { ?>
	...
	<a target="_blank" href="<?php echo $base_url; ?>admin-resume-view.php?user_id=<?php echo $page_row['user_id']; ?>" class="btn btn-success"> 
		<i class="fas fa-eye"></i> View CV	</a>
