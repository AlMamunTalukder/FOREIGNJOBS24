...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        <h1 class="title">  Testimonial Add   </h1>
                        <p class="title-description"> New Testimonial  </p>
                    </div>
                        ...
                        <div class="row sameheight-container">
                            <div class="col-md-12">
                                <div class="card card-block sameheight-item">
                                    ...
                                    <form name="submit" id="submit" method="post" action="testimonial_add_ac.php" enctype="multipart/form-data">
									
										
									
                                        <div class="form-group"> 
											<label class="control-label">Name</label> 
											<input type="text" class="form-control boxed" name="name" placeholder="Enter Name " required>  
										</div>
										
										 <div class="form-group"> 
											<label class="control-label">Designation</label> 
											<input type="text" class="form-control boxed" name="designation" placeholder="Enter Designation " required>  
										</div>
										
										 <div class="form-group"> 
											<label class="control-label">Testmonial</label> 
											<textarea name="description" class="form-control boxed" placeholder="Enter Testmonial " required="required"></textarea>  
										</div>
										
										 <div class="form-group"> 
											<label class="control-label">Photo</label> 
											 
											<input name="testimonial"  class="form-control" type="file" placeholder="Testimonial Image" required>
