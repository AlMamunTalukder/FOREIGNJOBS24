	...
	<div class="limiter">
		<div class="container-login100" style=" background-image: url(images/login_body-3.jpg);">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="forgot_pass_action.php" method="post" enctype="multipart/form-data" >
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<input class="input100" type="password" name="password" placeholder="New Password" autocomplete="off" required>
						
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
					
						<input class="input100" type="password" name="agin_password" placeholder="Agin Password" autocomplete="off" required>
						
					</div>

					<div class="container-login100-form-btn m-t-32">
					
						<button class="login100-form-btn" type="submit" name="login_submit">Submit</button>
