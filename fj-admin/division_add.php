...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        <h1 class="title">  Division  Add   </h1>
                        <p class="title-description"> New Division  </p>
                    </div>
                        ...
                        <div class="row sameheight-container">
                            <div class="col-md-12">
                                <div class="card card-block sameheight-item">
                                    ...
                                    <form name="submit" id="submit" method="post" action="division_add_ac.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group"> 
											...
											<input type="text" class="form-control boxed" name="division_name" placeholder="Enter Division Name" required>  
										</div>
