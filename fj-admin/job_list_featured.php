...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM job_listing WHERE fea_job = '1' ORDER BY ID ASC ");
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
			 ...
			 $page_run = mysqli_query($con,"SELECT * FROM job_listing WHERE fea_job = '1' ORDER BY ID DESC LIMIT $current, $limit");
