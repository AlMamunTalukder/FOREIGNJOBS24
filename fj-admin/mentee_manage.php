...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM mentee_info ORDER BY ID DESC");
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        <h1 class="title">  Mentee Manage   </h1>
                        <p class="title-description"> All Mentee List</p>
                    </div>
										...
										<div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
													 ...
													 $page_run = mysqli_query($con,"SELECT * FROM mentee_info ORDER BY ID DESC LIMIT $current, $limit");
													 while ($page_row = mysqli_fetch_array($page_run)) {
													 $id = $page_row['id'];
													 
													 $table_name = "mentee_info";
												   ...
												   <tr>
														...
														<a href="mentee_full_profile.php?id=<?php echo $id; ?>" class="btn btn-success"> 
