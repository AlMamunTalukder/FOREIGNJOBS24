...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        ...
                        <p class="title-description"> All Jobs  List</p>
                    </div>
			 ...
			 $page_run = mysqli_query($con,"SELECT * FROM job_listing ORDER BY ID DESC LIMIT $current, $limit");
...
<?php  
	...
	if ($page_row['fea_job']==1 && $get_permission_data['admin_role'] == 0) { 
?>
