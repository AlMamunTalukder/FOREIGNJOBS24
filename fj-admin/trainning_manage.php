...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM trainning_manage ORDER BY ID DESC ");
										...
										<div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
													 ...
													 $page_run = mysqli_query($con,"SELECT * FROM trainning_manage ORDER BY ID DESC LIMIT $current, $limit");
													 while ($page_row = mysqli_fetch_array($page_run)) {
													 $id = $page_row['id'];
													 
													 $table_name = "trainning_manage";
													 
                                                   ?>
                                                    <tr>
														 <td><?php echo $id; ?> </td>
                                                        <td style="text-align:left;"><?php echo $category_name = $page_row['category_name']; ?> </td>
														<td style="text-align:left;"><?php echo $title = $page_row['title']; ?> </td>
														<td style="text-align:left;"><?php echo $fees = $page_row['fees']; ?> </td>
														<td style="text-align:left;"><?php echo $dates = $page_row['dates']; ?> </td>
														<td style="text-align:left;"><?php echo $tutor_name = $page_row['tutor_name']; ?> </td>
