...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM division_manage ORDER BY ID ASC ");
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        <h1 class="title">  Division Manage   </h1>
                        <p class="title-description"> All Division List</p>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-block">
										...
										<div class="card-title-block">
                                            <a href="division_add.php" class="btn btn-success btn-block btn-lg"> 
										...
										<div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
													 ...
													 $page_run = mysqli_query($con,"SELECT * FROM division_manage ORDER BY ID DESC LIMIT $current, $limit");
													 ...
													 $table_name = "division_manage";
													 
                                                   ?>
                                                    <tr>
														 <td><?php echo $id; ?> </td>
														 <td><?php echo $country_name = $page_row1['country_name']; ?> </td>
                                                        <td><?php echo $division_name = $page_row['division_name']; ?> </td>
