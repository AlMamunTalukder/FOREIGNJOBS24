...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM job_listing WHERE status = '2' ORDER BY ID ASC ");
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
			 ...
			 $page_run = mysqli_query($con,"SELECT * FROM job_listing WHERE status = '2' ORDER BY ID DESC LIMIT $current, $limit");
...
<?php } else { ?>
	...
	<i class="fas fa-check"></i> Re-Approve ?	</a>
...
?>	      
<?php if ($get_permission_data['admin_role'] == 0) { ?>
