...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$limit = 25;
						 ...
						 //show records
           			 	$query =  mysqli_query($con,"SELECT * FROM job_listing WHERE status = '0' ORDER BY ID ASC ");
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
                <article class="content static-tables-page">
                    <div class="title-block">
                        <h1 class="title">  Jobs List (Pending)   </h1>
                        <p class="title-description"> All Jobs List (Pending)</p>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="card-title-block">
                                            <h3 class="title"> Jobs List (Pending) </h3>
                                        </div>
			 ...
			 $page_run = mysqli_query($con,"SELECT * FROM job_listing WHERE status = '0' ORDER BY ID DESC LIMIT $current, $limit");
...
<?php } else { ?>
	...
	<a href="job_live.php?id=<?php echo $id; ?>&email=<?php echo $recurator_info['email']; ?>&job_title=<?php echo $page_row['job_title']; ?>" 
