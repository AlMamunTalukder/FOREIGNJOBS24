...
$user_image_data155 = $user_image_result->fetch_assoc();
...
<div class="col-md-9"> 
  ...
  <div class="user-content">
    <div class="panel-heading panel-heading-01">
      <i class="fa fa-eye"></i>  Resume View
      <span style="float: right;margin: -6px 0px 0px 0px;"> 
	  
	  <a href="down_pdf.php?user_id=<?php echo $_REQUEST['user_id']; ?>" target="_blank" class="btn btn-default"> PDF Download  <i class="fa fa-cloud-download"></i> </a> 
...
?></span></h5>
      ...
      <div id="photo">
       ...
       <img src="../image/<?php if ($user_image_data155['image_file'] !=''){ echo $user_image_data155['image_file'];}else{ echo 'user.jpg';  }?>" alt="" />
      </div>
    </header>
    <hr>
