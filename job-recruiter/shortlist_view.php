...
<div class="col-md-9"> 
  ...
  <div class="user-content">
    <div class="panel-heading panel-heading-01"><i class="fa fa-list-alt" aria-hidden="true"></i> 
		<?php echo $job_title; ?> | Total Applied : <?php echo $job_apply_Data; ?> | Shortlist
	...
	<a href="gotjob_list.php?job_id=<?php echo $job_id; ?>"  class="btn btn-success btn-lg" >Got Job</a>
     ...
     <table class="table">
		...
		<tbody>
		<?php
			$job_apply1 = mysqli_query($con, "SELECT * FROM job_apply WHERE job_id = '$job_id' and status = '1' ORDER BY ID DESC");
		...
		?>
		  ...
		  <tr>
			<td colspan="4" align="center">
			  ...
			  <a href="got_job_ac.php?user_id=<?php echo $user_id_view; ?>&job_id=<?php echo $job_id; ?>" class="btn btn-success" style="background:#dd4e41; border:1px solid #dd4e41;"
			   onclick="return confirm('Got The Job< ?')">Got The Job</a>	
