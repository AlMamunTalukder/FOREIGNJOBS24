...
<script type="text/javascript" src="fj-admin/tinymce/tinymce.min.js"></script>
...
<script type="text/javascript">
	...
	<link rel="stylesheet" href="job-recruiter/datepicker/datepickercss2.css"/>
</head>
<body>
  ...
  <div class="user-content">
    ...
    <div class="ucon-panel-body">
      ...
      <div class="panel-body">
			...
			<form method="post" action="job-details-edit-ac.php" enctype="multipart/form-data">
...
<h3 class="no-margin">
<a href="#"> <?php echo $recurator_info["company_name"]; ?> </a>
</h3>
<p>
...
<script src="job-recruiter/datepicker/datepickerjs.js"></script>
