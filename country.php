...
<html lang="en">
<head>
<title> <?php echo $c; ?> |  <?php echo $title; ?> </title>
...
<?php include 'filter.php';?>
      ...
      <div class="col-md-9 col-sm-8 jobs-list-all">
		...
		<?php
			$c = $_REQUEST["c"];
			$user_resume = mysqli_query($con, "SELECT * FROM job_listing WHERE country = '$c' and status = '1' and fea_job = '1' ORDER BY rand() LIMIT 2");
	...
	?>
      ...
      <?php 
			...
			$user_resume = mysqli_query($con, "SELECT * FROM job_listing WHERE country = '$c' and status = '1' and fea_job = '0' ORDER BY id DESC");
