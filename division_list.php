...
<title> All Division |  <?php echo $title; ?> </title>
    ...
    <div class="row">
	 ...
	 <?php
					...
					$country_id = $all_country["id"];
					  ...
					  $qd1 = mysqli_query($con,"SELECT * FROM division_manage WHERE country_id = '$country_id' ORDER BY ID ASC");
					  $qdiv = mysqli_num_rows($qd1);
...
<div class="col-md-4">
        ...
        <div class="listWrpService">
            ...
            <div class="sa_com_info">
				...
				<a href="division.php?d=<?php echo $division_name = $division_manage['division_name']; ?>"> 
				<?php echo $division_name = $division_manage['division_name']; ?>
				</a>
